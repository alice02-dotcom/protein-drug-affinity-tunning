...
#aaindex를 위한 불러오기
from protein_feature_builder import ProteinBranch, AAindexFeatureEmbedder, AAINDEX_DICT, AAINDEX_KEYS
...
class DeepDrug_Container(LightningModule):
    def __init__(self,num_out_dim=1,
        ...
        if self.category == 'DDI':
            ...
            self.entry2_in_channel= 86 #기존 78 + 2에서 aaindex 8차원 추가 근데 2빼봄
